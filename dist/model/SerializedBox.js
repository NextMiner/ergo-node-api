 ...
 * @version 4.0.14
 */
var SerializedBox = /*#__PURE__*/function () {
  /**
   ...
   */
  function SerializedBox(boxId, bytes) {
    _classCallCheck(this, SerializedBox);
  ...
  _createClass(SerializedBox, null, [{
    key: "initialize",
    value: function initialize(obj, boxId, bytes) {
      obj['boxId'] = boxId;
      obj['bytes'] = bytes;
    }
    /**
