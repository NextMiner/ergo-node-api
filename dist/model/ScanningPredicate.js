 ...
 * @version 4.0.14
 */
var ScanningPredicate = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ScanningPredicate</code>.
   * @alias module:model/ScanningPredicate
   * @param predicate {String} 
   */
  function ScanningPredicate(predicate) {
    _classCallCheck(this, ScanningPredicate);
  ...
  _createClass(ScanningPredicate, null, [{
    key: "initialize",
...
var _default = ScanningPredicate;
