...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErgoNodeApi.SecretProven();
  });
  ...
  describe('SecretProven', function() {
    it('should create an instance of SecretProven', function() {
      // uncomment below and update the code to test SecretProven
      //var instane = new ErgoNodeApi.SecretProven();
      //expect(instance).to.be.a(ErgoNodeApi.SecretProven);
    });

    it('should have the property hint (base name: "hint")', function() {
      // uncomment below and update the code to test the property hint
      //var instance = new ErgoNodeApi.SecretProven();
