...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErgoNodeApi.Extension();
  });
  ...
  describe('Extension', function() {
    it('should create an instance of Extension', function() {
      ...
      //var instane = new ErgoNodeApi.Extension();
      //expect(instance).to.be.a(ErgoNodeApi.Extension);
    });
    ...
    it('should have the property headerId (base name: "headerId")', function() {
      ...
      //var instance = new ErgoNodeApi.Extension();
