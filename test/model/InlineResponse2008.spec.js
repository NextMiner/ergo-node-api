...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErgoNodeApi.InlineResponse2008();
  });
  ...
  describe('InlineResponse2008', function() {
    it('should create an instance of InlineResponse2008', function() {
      ...
      //var instane = new ErgoNodeApi.InlineResponse2008();
      //expect(instance).to.be.a(ErgoNodeApi.InlineResponse2008);
    });

    it('should have the property tree (base name: "tree")', function() {
      // uncomment below and update the code to test the property tree
      //var instance = new ErgoNodeApi.InlineResponse2008();
