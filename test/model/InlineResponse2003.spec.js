...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErgoNodeApi.InlineResponse2003();
  });
  ...
  describe('InlineResponse2003', function() {
    it('should create an instance of InlineResponse2003', function() {
      ...
      //var instane = new ErgoNodeApi.InlineResponse2003();
      //expect(instance).to.be.a(ErgoNodeApi.InlineResponse2003);
    });

    it('should have the property address (base name: "address")', function() {
      // uncomment below and update the code to test the property address
      //var instance = new ErgoNodeApi.InlineResponse2003();
