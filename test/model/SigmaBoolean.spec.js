...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErgoNodeApi.SigmaBoolean();
  });
  ...
  describe('SigmaBoolean', function() {
    it('should create an instance of SigmaBoolean', function() {
      // uncomment below and update the code to test SigmaBoolean
      //var instane = new ErgoNodeApi.SigmaBoolean();
      //expect(instance).to.be.a(ErgoNodeApi.SigmaBoolean);
    });

    it('should have the property op (base name: "op")', function() {
      // uncomment below and update the code to test the property op
      //var instance = new ErgoNodeApi.SigmaBoolean();
