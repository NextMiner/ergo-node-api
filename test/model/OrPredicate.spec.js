...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErgoNodeApi.OrPredicate();
  });
  ...
  describe('OrPredicate', function() {
    it('should create an instance of OrPredicate', function() {
      // uncomment below and update the code to test OrPredicate
      //var instane = new ErgoNodeApi.OrPredicate();
      //expect(instance).to.be.a(ErgoNodeApi.OrPredicate);
    });
    ...
    it('should have the property predicate (base name: "predicate")', function() {
      ...
      //var instance = new ErgoNodeApi.OrPredicate();
