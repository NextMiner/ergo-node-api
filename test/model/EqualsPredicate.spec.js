...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErgoNodeApi.EqualsPredicate();
  });
  ...
  describe('EqualsPredicate', function() {
    it('should create an instance of EqualsPredicate', function() {
      // uncomment below and update the code to test EqualsPredicate
      //var instane = new ErgoNodeApi.EqualsPredicate();
      //expect(instance).to.be.a(ErgoNodeApi.EqualsPredicate);
    });
    ...
    it('should have the property predicate (base name: "predicate")', function() {
      ...
      //var instance = new ErgoNodeApi.EqualsPredicate();
