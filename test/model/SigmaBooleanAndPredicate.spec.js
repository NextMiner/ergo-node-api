...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErgoNodeApi.SigmaBooleanAndPredicate();
  });
  ...
  describe('SigmaBooleanAndPredicate', function() {
    it('should create an instance of SigmaBooleanAndPredicate', function() {
      // uncomment below and update the code to test SigmaBooleanAndPredicate
      //var instane = new ErgoNodeApi.SigmaBooleanAndPredicate();
      //expect(instance).to.be.a(ErgoNodeApi.SigmaBooleanAndPredicate);
    });

    it('should have the property op (base name: "op")', function() {
      // uncomment below and update the code to test the property op
      //var instance = new ErgoNodeApi.SigmaBooleanAndPredicate();
