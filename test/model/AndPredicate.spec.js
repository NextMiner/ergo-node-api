...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErgoNodeApi.AndPredicate();
  });
  ...
  describe('AndPredicate', function() {
    it('should create an instance of AndPredicate', function() {
      // uncomment below and update the code to test AndPredicate
      //var instane = new ErgoNodeApi.AndPredicate();
      //expect(instance).to.be.a(ErgoNodeApi.AndPredicate);
    });
    ...
    it('should have the property predicate (base name: "predicate")', function() {
      ...
      //var instance = new ErgoNodeApi.AndPredicate();
