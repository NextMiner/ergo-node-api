...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErgoNodeApi.InlineResponse2001();
  });
  ...
  describe('InlineResponse2001', function() {
    it('should create an instance of InlineResponse2001', function() {
      ...
      //var instane = new ErgoNodeApi.InlineResponse2001();
      //expect(instance).to.be.a(ErgoNodeApi.InlineResponse2001);
    });
    ...
    it('should have the property matched (base name: "matched")', function() {
      ...
      //var instance = new ErgoNodeApi.InlineResponse2001();
