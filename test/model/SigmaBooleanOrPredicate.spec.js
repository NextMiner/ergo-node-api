...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErgoNodeApi.SigmaBooleanOrPredicate();
  });
  ...
  describe('SigmaBooleanOrPredicate', function() {
    it('should create an instance of SigmaBooleanOrPredicate', function() {
      // uncomment below and update the code to test SigmaBooleanOrPredicate
      //var instane = new ErgoNodeApi.SigmaBooleanOrPredicate();
      //expect(instance).to.be.a(ErgoNodeApi.SigmaBooleanOrPredicate);
    });

    it('should have the property op (base name: "op")', function() {
      // uncomment below and update the code to test the property op
      //var instance = new ErgoNodeApi.SigmaBooleanOrPredicate();
